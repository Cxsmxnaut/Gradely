...
<sub>StudentVUE is a registered trademark of Edupoint Educational Systems LLC. Gradely is not affiliated with or endorsed by Edupoint Educational Systems LLC.</sub>
...
When hosting your own version of Gradely, please [change](src/lib/brand.ts) the name, contact email, and repository link to avoid confusion with our version.

Vercel and Netlify are both good options for hosting SvelteKit apps like Gradely.

## License

Gradely is licensed under the [GNU AGPLv3](https://choosealicense.com/licenses/agpl-3.0/), an open-source copyleft license. What this means for you is that if you

- modify the source code of Gradely, and
